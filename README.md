...
Портфельный проект по операционной аналитике службы поддержки: обращения, sla, backlog, нагрузка агентов, витрины для bi-дашборда и базовый прогноз дневного объема тикетов.
